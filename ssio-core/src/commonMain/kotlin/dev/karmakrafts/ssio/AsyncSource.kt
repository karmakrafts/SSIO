...
suspend inline fun AsyncSource.readShortLe(): Short = readShort().reverseBytes()

/** Reads a signed 32-bit value. */
suspend inline fun AsyncSource.readIntLe(): Int = readInt().reverseBytes()

/** Reads a signed 64-bit value. */
suspend inline fun AsyncSource.readLongLe(): Long = readLong().reverseBytes()
