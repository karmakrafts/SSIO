...
interface AsyncSink : AsyncRawSink {
    ...
    /** Writes a single signed 16-bit value, little-endian unless documented otherwise. */
    suspend fun writeShortLe(value: Short)

    /** Writes a single signed 32-bit value, little-endian unless documented otherwise. */
    suspend fun writeIntLe(value: Int)

    /** Writes a single signed 64-bit value, little-endian unless documented otherwise. */
    suspend fun writeLongLe(value: Long)
